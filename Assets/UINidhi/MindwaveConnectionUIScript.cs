...
public class MindwaveConnectionUIScript : MonoBehaviour
{
    #region Attributes
    ...
    public List<GameObject>DeviceStatus = new List<GameObject>();
    ...
    public void ShowConnectionStatus()
    {
        ...
        {
            //Debug.Log("Trying to connect to Mindwave...");
          //  DeviceStatus[2].SetActive(true);
        }

        else if (m_Controller.IsConnected)
        {
           // Debug.Log("Mindwave device is connected");
            DeviceStatus[0].SetActive(true);
        }

        else if (!m_Controller.IsConnected)
        {
           // Debug.Log("Mindwave device is disconnected");
            DeviceStatus[1].SetActive(true);
        }
        else
        {
            //Debug.Log("You lost the server");
            DeviceStatus[2].SetActive(true);
        }
    }
