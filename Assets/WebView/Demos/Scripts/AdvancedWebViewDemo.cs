...
namespace Vuplex.WebView.Demos
{
    ...
    class AdvancedWebViewDemo : MonoBehaviour
    {
        ...
        async void Start()
        {
            ...
            _mainWebViewPrefab = WebViewPrefab.Instantiate(3f, 1.5f);
            _mainWebViewPrefab.transform.parent = transform;
            _mainWebViewPrefab.transform.localPosition = new Vector3(0, -0.03f, 1.95f);
            ...
            _controlsWebViewPrefab = WebViewPrefab.Instantiate(3f, 0.1f);
            _controlsWebViewPrefab.transform.parent = _mainWebViewPrefab.transform;
            _controlsWebViewPrefab.transform.localPosition = new Vector3(0, 0.3f, 0);
        ...
        void _setUpKeyboards()
        {
            ...
            var keyboard = Keyboard.Instantiate(2f, 0.7f);
            keyboard.gameObject.layer = 5;
            keyboard.transform.SetParent(_mainWebViewPrefab.transform, false);
            keyboard.transform.localPosition = new Vector3(0, -1.55f, 0);
