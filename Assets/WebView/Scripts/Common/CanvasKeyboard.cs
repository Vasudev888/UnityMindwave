...
namespace Vuplex.WebView {
    ...
    public class CanvasKeyboard : BaseKeyboard {
        ...
        //[SerializeField] XritWebViewLocal xritWebViewLocal;
        ...
        void _initCanvasKeyboard() {
            ...
            //rectTransform.offsetMin = new Vector2(0, 600); // new Vector2(left, bottom);

            //Should be this - Constant
            rectTransform.offsetMin = new Vector2(0, -600);
            rectTransform.offsetMax = new Vector2(0, -600); // new Vector2(-right, -top);

            //xritWebViewLocal = this.gameObject.transform.root.GetComponent<XritWebViewLocal>();

            ////Should be this
            //rectTransform.offsetMin = new Vector2(0, -xritWebViewLocal.vectorY);
            //rectTransform.offsetMax = new Vector2(0, -xritWebViewLocal.vectorY); // new Vector2(-right, -top);
