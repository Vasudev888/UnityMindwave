...
Shader "Unlit/HeatmapShader"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // Move initialization to vertex shader or outside fragment shader
            void initialize()
            {
            ...
            // Distance function for heatmap influence
            float distsq(float2 a, float2 b)
            {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                // Return the base texture color plus the heatmap contribution
                return col + float4(heatColor, 0.5);  // Apply heatmap with some transparency
            }
